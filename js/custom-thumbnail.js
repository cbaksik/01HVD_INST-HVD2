...
angular.module('viewCustom')
    .component('customThumbnail', {
        templateUrl:'/discovery/custom/01HVD_INST-HVD2/html/custom-thumbnail.html',
        bindings: {
            itemdata:'<',
            searchdata: '<'
        },
        ...
        controller:['$element','$timeout','prmSearchService',function ($element,$timeout,prmSearchService) {
            ...
            vm.imageUrl='/discovery/custom/01HVD_INST-HVD2/img/icon_image.png';
            vm.src='';
            vm.imageCaption='';
            vm.restricted=false;
            vm.imageFlag=false;
                ...
                if(vm.src && vm.imageFlag) {
                    ...
                    $timeout(function () {
                        ...
                        if(pattern.test(vm.src)) {
                            img.src='/discovery/custom/01HVD_INST-HVD2/img/icon_image.png';
                        }
